...
export const Route = createFileRoute("/destinations")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore safari destinations across Africa: Bwindi, Serengeti, Maasai Mara, Victoria Falls, Namib desert, Zanzibar, Amboseli." },
      { property: "og:title", content: "Destinations — Savana Safaris" },
      { property: "og:description", content: "Hand-crafted safari journeys across the continent." },
    ],
  }),
