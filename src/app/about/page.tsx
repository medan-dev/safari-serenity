...
export const metadata: Metadata = {
  ...
  description: "Conscious safari operators since 2008. Local guides, fair-share lodges, and a portion of every trip funded back to conservation.",
  openGraph: {
    title: "About — Savana Safaris",
    description: "Conscious safari operators across the African continent.",
  },
};
